...
//                optionsBuilder.UseSqlServer("Data Source=PPAWAR-LAP-0704\\MSSQLSERVER02;Initial Catalog=eShoppingCodi;Integrated Security=SSPI");
//            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                entity.HasKey(e => e.DeptNo)
                    .HasName("PK__Departme__0148CAAE278F5F31");
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                entity.HasKey(e => e.EmpNo)
                    .HasName("PK__Employee__AF2D66D3CEBD9F75");
                ...
                entity.HasOne(d => d.DeptNoNavigation)
                    ...
                    .HasConstraintName("FK__Employee__DeptNo__44FF419A");
            });
            ...
            {
                entity.HasKey(e => e.PersonUniqueId);
                ...
                entity.Property(e => e.PersonName).HasMaxLength(400);
            });

            modelBuilder.Entity<Product>(entity =>
            {
                entity.HasKey(e => e.ProductUniqueId)
                    .HasName("PK__Product__8377B53A88329C56");
                ...
                entity.HasOne(d => d.Manufacturer)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Product__Manufac__403A8C7D");
            });
            ...
            modelBuilder.Entity<Project>(entity =>
            {
                ...
                entity.Property(e => e.ManagerName).HasMaxLength(1000);

                entity.Property(e => e.ProjectName).HasMaxLength(200);

                entity.Property(e => e.Technology).HasMaxLength(1000);
            });
