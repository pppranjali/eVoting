...
void JsonDeSerializeMethod(int id)
{
    staff1.StaffId = id;
    Stream fs = new FileStream($@"c:\Coditas\Files\{staff1.StaffId}.json", FileMode.Open);
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
    Staff st = JsonSerializer.Deserialize<Staff>(fs);
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
#pragma warning disable CS8602 // Dereference of a possibly null reference.
    Console.WriteLine($"StaffName: {st.StaffName}");
...
do
{
    ...
    Console.WriteLine("6. Get Information through file");
...
#pragma warning restore CS8601 // Possible null reference assignment.
                        ...
                        Staff.DocID++;
                        void JsonSerializerMethod()
                        {
                            Stream fs = new FileStream($@"c:\Coditas\Files\{doctor.StaffId}.json", FileMode.CreateNew);
                            JsonSerializer.Serialize(fs, doctor);
                            fs.Close(); // CLose the File
                            fs.Dispose(); // Release the Object
                        }
                        ...
                        {
                            doctor.StaffId = id;
                            Stream fs = new FileStream($@"c:\Coditas\Files\{doctor.StaffId}.json", FileMode.Open);
                            Staff st=JsonSerializer.Deserialize<Staff>(fs);
                            Console.WriteLine($"StaffName: {st.StaffName}");
                            Console.WriteLine("The Object is DeSerialized");
                            fs.Close(); // CLose the File
...
#pragma warning restore CS8601 // Possible null reference assignment.
                        ...
                        void JsonSerializerMethod()
                        {
                            Stream fs = new FileStream($@"c:\Coditas\Files\{nurse.StaffId}.json", FileMode.CreateNew);
                            JsonSerializer.Serialize(fs, nurse);
                            fs.Close(); // CLose the File
                            fs.Dispose(); // Release the Object
                        }
                        JsonSerializerMethod();
...
#pragma warning restore CS8601 // Possible null reference assignment.
                        ...
                        void JsonSerializerMethod()
                        {
                            Stream fs = new FileStream($@"c:\Coditas\Files\{driver.StaffId}.json", FileMode.CreateNew);
                            JsonSerializer.Serialize(fs, driver);
                            fs.Close(); // CLose the File
                            fs.Dispose(); // Release the Object
                        }
                        JsonSerializerMethod();
