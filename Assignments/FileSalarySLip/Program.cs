...
Staff.NurseID = 2000;
Staff.DriverID = 3000;
static String Output(long number)
{
        ...
        case 5:
            ...
            foreach (var d in Doctors)
            {
                if (d.StaffId == id5)
                {
                    ...
                    flag1 = 1;
                    string str = $"  Staff Name:: {d.StaffName}     StaffID:: {d.StaffId}      Staff Type:: Doctor \n =============================================================================================\n INCOME DETAILS \n Basic Pay::{d.BasicPay}      IN WORDS:: {Output(d.BasicPay)} \n GROSS INCOME::{gross}    IN WORDS::{Output(gross)} \n HOSPITAL SHARE::{HospitalShare}    IN WORDS::{Output(HospitalShare)} \n TAX::{tax}      IN WORDS::{Output(tax)} \n NETINCOME::{NetIncome}     IN WORDS::{Output(NetIncome)} \n =============================================================================================";

                    Console.WriteLine($"=============================================================================================");
                    Console.WriteLine($"Staff Name:: {d.StaffName}     StaffID:: {d.StaffId}      Staff Type:: Doctor");
                    Console.WriteLine($"=============================================================================================");
                    Console.WriteLine("INCOME DETAILS");
                    Console.WriteLine($"Basic Pay:: {d.BasicPay}                 IN WORDS:: {Output(d.BasicPay)} ");
                    ...
                    string fileName = @$"C:\Coditas\Salaryslip\{d.StaffId}_{d.StaffName}.txt";
